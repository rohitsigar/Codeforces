	...
	/*--------------------------------------------------------------------------------------------------------------------------*/
	 ...
	 else
	 {
	 	...
	 	for(int i=1;i<n-1;i++)
	 	{
	 		...
	 		if(abs(abs(a[i]) - abs(a[i+1])) - abs(abs(a[i]) + abs(a[i +1])) > abs(abs(a[ind1]) - abs(a[ind2])) - abs(abs(a[ind1]) + abs(a[ind2])))
	 		{
	 			ind1 = i;
	 			ind2 = i+1;
	 		}
	 	...
	 	for(int i=0;i<n;i++) sum+=abs(a[i]);
	 		...
	 		sum = sum + abs(abs(a[ind1]) - abs(a[ind2])) - abs(abs(a[ind1]) + abs(a[ind2]));
	 	cout<<sum<<nline;
